...
function RequestLoading({
  ...
  return (
    <div
      className={cn(
        "absolute top-0 z-20 flex h-full w-full animate-pulse items-center justify-center bg-white p-10",
        !isProcessing && "hidden",
      )}
    >
      <div className="-mt-28 flex flex-col items-center gap-3 text-xl">
        <p className="text-center leading-relaxed tracking-wider text-blue-800">
          {text}
        </p>
      </div>
    </div>
